...
git push --follow-tags https://${CLIENTS_CREDENTIALS}@${REPOSITORY_CLIENTS_JAVA} ${branch_name}
git pull https://${CLIENTS_CREDENTIALS}@${REPOSITORY_CLIENTS_JAVA} ${branch_name}

cd cumulocity-sdk
git checkout ${branch_name}
git push --follow-tags https://${SDK_CREDENTIALS}@${REPOSITORY_SDK} ${branch_name}
git pull https://${SDK_CREDENTIALS}@${REPOSITORY_SDK} ${branch_name}
cd -
