...
public class EventIT extends JavaSdkITBase {
    ...
    public void deleteEvents() throws Exception {
        List eventsOn1stPage = getEventsFrom1stPage();
    ...
    private List getEventsFrom1stPage() throws SDKException {
        return ((EventCollectionRepresentation) eventApi.getEvents().get()).getEvents();
    }
    ...
    public void iGetAllEvents() throws SDKException {
        try {
            collection = (EventCollectionRepresentation) eventApi.getEvents().get();
        } catch (SDKException ex) {
            status = ex.getHttpStatus();
        }
    }
    ...
    public void iGetEventsWithCreatedId() throws SDKException {
        try {
            result1.add(eventApi.getEvent(((EventRepresentation) result.get(0)).getId()));
        } catch (SDKException ex) {
            status = ex.getHttpStatus();
        }
    }
    ...
    public void iDeleteEventsWithCreatedId() throws SDKException {
        try {
            eventApi.delete((EventRepresentation) result.get(0));
        } catch (SDKException ex) {
            status = ex.getHttpStatus();
        }
    }
    ...
    public void iQueryAllByPageNumber(int pageNumber) throws SDKException {
        try {
            collection1 = (EventCollectionRepresentation) eventApi.getEvents().getPage(collection, pageNumber);
        } catch (SDKException ex) {
            status = ex.getHttpStatus();
        }
    }
