...
public class ConfigurationKey {
    ...
    public static final ConfigurationKey CONNECTION_SETUP_PARAMS_REALTIME = new ConfigurationKey("connection.setup.params.realtime", ";bearer_type=gprs;access_point=internet.m2mportal.de;username=m2m;password=sim;timeout=780");
    public static final ConfigurationKey CONNECTION_HEARTBEAT_CHECK_INTERVAL = new ConfigurationKey("connection.heartbeat.check.interval", "720");
    ...
    public static ConfigurationKey[] getAll() {
        return new ConfigurationKey[]{
                ...
                CONNECTION_HEARTBEAT_CHECK_INTERVAL,
