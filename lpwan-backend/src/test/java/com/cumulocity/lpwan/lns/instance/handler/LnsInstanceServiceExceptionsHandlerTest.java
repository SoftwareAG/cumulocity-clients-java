...
class LnsInstanceServiceExceptionsHandlerTest {
    ...
    @Test
    void doHandleException_LnsInstanceServiceException() {
        LnsInstanceServiceException exception = new LnsInstanceServiceException("LnsInstanceService failed with internal service error.", new Exception("Some internal error."));
        ResponseEntity<ErrorMessageRepresentation> responseEntity = new LnsInstanceServiceExceptionsHandler().handleLnsInstanceServiceException(exception);
        ...
        ErrorDetails details = errorMessageRepresentation.getDetails();
        assertNotNull(details);
        assertEquals(LnsInstanceServiceException.class.getCanonicalName(), details.getExpectionClass());
        assertEquals(exception.getMessage(), details.getExceptionMessage());
    }
}