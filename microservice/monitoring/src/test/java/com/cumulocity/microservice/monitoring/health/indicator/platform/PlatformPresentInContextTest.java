...
@DirtiesContext
@SpringBootTest(classes = {TestHealthIndicatorConfiguration.class, TestPlatformConfiguration.class})
public class PlatformPresentInContextTest extends MockMvcTestBase {
