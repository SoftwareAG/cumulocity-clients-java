...
@EnableWebMvc
// Application starts with neither EncoderService nor DecoderService implementation
public class CodecControllerTest_NoEncoderAndDecoderImplementations {
    @Autowired
    ...
    @Test
    public void doCallEncodeAPI_withValidJSONInput_NoDecoderAndEncoderService_Failure() throws Exception {
    ...
    @Test
    public void doCallDecodeAPI_withValidJSONInput_NoDecoderAndEncoderService_Failure() throws Exception {
