...
@EnableWebMvc
// Application starts with only DecoderService implementation
public class CodecControllerTest_NoEncoderImplementation {
    @Autowired
    ...
    // The goal of this test is to prove that the Encode API call fails with HTTP 405 error (UnsupportedOperationException) as there is no EncoderService implementation.
    @Test
    public void doCallEncodeAPI_withValidJSONInput_NoEncoderService_Failure() throws Exception {
    ...
    // This test succeeds as there is a DecoderService implementation
    @Test
    public void doCallDecodeAPI_withValidJSONInput_NoEncoderService_Success() throws Exception {
