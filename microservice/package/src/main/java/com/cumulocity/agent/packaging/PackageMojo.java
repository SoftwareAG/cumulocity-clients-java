...
public class PackageMojo extends BaseMicroserviceMojo {
    ...
    public void execute() throws MojoExecutionException {
        ...
        if (!containerSkip) {
            ...
            log.info("Starting docker microservice build for the following target architectures: {}", Collections.unmodifiableList(new ArrayList<>(Arrays.asList(buildTargetArchitectures))));
